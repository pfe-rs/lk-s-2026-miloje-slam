...
static const _LidarSweep_type_support_symbol_names_t _LidarSweep_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lidar_msgs, msg, LidarSweep)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lidar_msgs, msg, LidarSweep)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, lidar_msgs, msg, LidarSweep)() {
  return &::lidar_msgs::msg::rosidl_typesupport_c::LidarSweep_message_type_support_handle;
}
