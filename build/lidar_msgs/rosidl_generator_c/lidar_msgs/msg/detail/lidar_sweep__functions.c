...
lidar_msgs__msg__LidarSweep__init(lidar_msgs__msg__LidarSweep * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    lidar_msgs__msg__LidarSweep__fini(msg);
    return false;
  }
  // angles
...
lidar_msgs__msg__LidarSweep__create()
{
  ...
  lidar_msgs__msg__LidarSweep * msg = (lidar_msgs__msg__LidarSweep *)allocator.allocate(sizeof(lidar_msgs__msg__LidarSweep), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(lidar_msgs__msg__LidarSweep));
  bool success = lidar_msgs__msg__LidarSweep__init(msg);
  if (!success) {
...
lidar_msgs__msg__LidarSweep__Sequence__init(lidar_msgs__msg__LidarSweep__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lidar_msgs__msg__LidarSweep * data = NULL;

  if (size) {
    data = (lidar_msgs__msg__LidarSweep *)allocator.zero_allocate(size, sizeof(lidar_msgs__msg__LidarSweep), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = lidar_msgs__msg__LidarSweep__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        lidar_msgs__msg__LidarSweep__fini(&data[i - 1]);
      }
...
lidar_msgs__msg__LidarSweep__Sequence__fini(lidar_msgs__msg__LidarSweep__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      lidar_msgs__msg__LidarSweep__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lidar_msgs__msg__LidarSweep__Sequence * array = (lidar_msgs__msg__LidarSweep__Sequence *)allocator.allocate(sizeof(lidar_msgs__msg__LidarSweep__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = lidar_msgs__msg__LidarSweep__Sequence__init(array, size);
  if (!success) {
...
lidar_msgs__msg__LidarSweep__Sequence__destroy(lidar_msgs__msg__LidarSweep__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    lidar_msgs__msg__LidarSweep__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
lidar_msgs__msg__LidarSweep__Sequence__are_equal(const lidar_msgs__msg__LidarSweep__Sequence * lhs, const lidar_msgs__msg__LidarSweep__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!lidar_msgs__msg__LidarSweep__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  lidar_msgs__msg__LidarSweep__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(lidar_msgs__msg__LidarSweep);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    lidar_msgs__msg__LidarSweep * data =
      (lidar_msgs__msg__LidarSweep *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!lidar_msgs__msg__LidarSweep__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          lidar_msgs__msg__LidarSweep__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!lidar_msgs__msg__LidarSweep__copy(
