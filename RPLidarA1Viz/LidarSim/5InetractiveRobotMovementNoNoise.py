...
class InteractiveLiDARSimulator:
    ...
    def get_intersection_distance(self, origin, angle):
        """Calculate distance to first intersection with any obstacle (NO NOISE)"""
        ...
        if distances:
            ...
            # NO NOISE - return exact distance
            return min_dist
        else:
            return None
    ...
    def setup_plot(self):
        ...
        self.fig.suptitle('Interactive LiDAR Simulator - WASD to Move, Enter to Scan (NO NOISE)', 
    ...
    def setup_main_plot(self):
        ...
        ax.set_title('Environment with LiDAR Scans (NO NOISE)')
    ...
    def run(self):
        ...
        self.setup_plot()
        print("=" * 60)
        print("Interactive LiDAR Simulator (NO NOISE)")
        print("=" * 60)
        print("Controls:")
        print("  W - Move Up")
        print("  A - Move Left")
